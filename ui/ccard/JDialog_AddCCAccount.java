...
public class JDialog_AddCCAccount extends javax.swing.JDialog {
    ...
    public JDialog_AddCCAccount(CardFrm parent) {
        ...
        accountTypeGroup.add(JRadioButton_Company);
        accountTypeGroup.add(JRadioButton_Personal);

        JRadioButton_Company.setText("Company");
        JRadioButton_Company.setActionCommand("Company");
        getContentPane().add(JRadioButton_Company);
        JRadioButton_Company.setBounds(140, 12, 100, 24);

        JRadioButton_Personal.setText("Personal");
        JRadioButton_Personal.setActionCommand("Personal");
        getContentPane().add(JRadioButton_Personal);
        JRadioButton_Personal.setBounds(140, 36, 100, 24);
    ...
    javax.swing.JRadioButton JRadioButton_Company = new javax.swing.JRadioButton();
    javax.swing.JRadioButton JRadioButton_Personal = new javax.swing.JRadioButton();
    ...
    void JButtonOK_actionPerformed(java.awt.event.ActionEvent event) {
        ...
        parentframe.isPersonal = JRadioButton_Personal.isSelected();
